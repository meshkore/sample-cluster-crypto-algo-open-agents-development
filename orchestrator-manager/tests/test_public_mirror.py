...
from quantlab_manager.public_mirror import PublicStatePublisher
from quantlab_manager.public_state import compact_public_snapshot
...
class PublicStateTest(unittest.TestCase):
    ...
    def test_publisher_sends_bearer_token(self):
        ...
        with (
            ...
            patch(
                "quantlab_manager.public_mirror.urlopen", return_value=Response()
            ) as open_request,
        ):
    ...
    def test_disabled_publisher_does_not_open_network(self):
        ...
        with patch("quantlab_manager.public_mirror.urlopen") as open_request:
