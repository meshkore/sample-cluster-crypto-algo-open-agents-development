...
system beside `quantlab_core` and `system002_intraday_momentum_5m` and it depends on the
...
```bash
python3 -m system006_oracle_net_15m.dataset --download      # BTCUSDT 15m: research + forward
python3 -m system006_oracle_net_15m.oracle  --plot          # the teacher, and its ceiling
python3 -m system006_oracle_net_15m.train                   # GPU train + purged walk-forward
python3 -m system006_oracle_net_15m.infer                   # export signal table
