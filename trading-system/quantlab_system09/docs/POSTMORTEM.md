...
| | | |
|---|---|---|
| Phase 1 | the whole record reconstructed — every asset from the day it first trades, players born and retired against observed activity, balances struck at 2025-12-31 | `python -m quantlab_system09.phase1` |
| Phase 2 | a model trained on how those players behaved | `python -m quantlab_system09.train` |
