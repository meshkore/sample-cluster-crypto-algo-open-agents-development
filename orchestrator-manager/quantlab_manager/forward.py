...
from quantlab_trading import regime
from quantlab_backtester.backtest import CostModel
from .config import Settings
from quantlab_backtester.data import DataManager, FAMILY_DATA_OVERRIDES, FocusedDataset
from .memory import ExperimentMemory
from quantlab_backtester.models import ENGINE_VERSION, Bar, utc_now
from quantlab_backtester.engine import LongOnlyPortfolioBacktester
from quantlab_trading.policy import MoneyManagement, policy_keys
from quantlab_trading.strategies import MARKET_CONTEXT_FAMILIES, build_strategy
...
class ForwardEvaluator:
    ...
    def evaluate(self, candidate_strategy_number: int | None = None) -> str | None:
        ...
        # a hand-maintained list here cost a result. This copy was additionally
        # missing `minimum_position_fraction`, so a stored policy's noise floor
