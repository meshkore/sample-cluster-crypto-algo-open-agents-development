...
- #QUANT11 in progress — flagship multi-factor vote (H-MULTI-001): trend + momentum + order-flow imbalance, >=2-of-3 to enter, 0-of-3 to exit. Committed directly to main per operator instruction to stop single-factor breadth-first testing; awaiting its Phase-1 result.
- #QUANT12 in progress — evolved H-MULTI-001 per direct feedback into a two-part regime-switching strategy (H-REGIME-001): 200-bar SMA bull/bear call gates a full-confidence trend branch and a reduced-confidence oversold-bounce branch; awaiting its Phase-1 result, to be compared against both QUANT11 and H-REV-001.
