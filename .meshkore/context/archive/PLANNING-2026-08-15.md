> **ARCHIVED 2026-09-16.** This was the research loop's backlog, written on 2026-08-15 and
> driven by a half-hourly check that no longer runs. It predates System 06 becoming the
> champion, so every ranking and "what to do next" below describes a laboratory that no
> longer exists. It is kept because the measured findings in it are real — in particular
> the quality score and the re-scoring of 59 archived runs.
>
> **For what to work on next, read `trading-system/systems/README.md`.**
