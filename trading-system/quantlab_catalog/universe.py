...
`system006_oracle_net_15m.universe`, which talks to Binance and writes a snapshot. This module
...
def load_universe(name: str = "universe.json") -> list[str]:
    ...
    if not path.is_file():
        raise FileNotFoundError(
            ...
            f"re-select it deliberately with `python -m system006_oracle_net_15m.universe`.")
