...
import system002_intraday_momentum_5m.momentum  # noqa: F401
from quantlab_core.brains import build, register
...
def known_parameters() -> set[str]:
    ...
    from system002_intraday_momentum_5m.momentum import DEFAULTS as PRIMARY
